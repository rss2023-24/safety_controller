...
class SafetyController:
    ...
    def __init__(self):
        ...
        rospy.Subscriber(self.LASER_SCAN_TOPIC, LaserScan, self.handleSafety)
        rospy.Subscriber(self.NAV_OUTPUT_TOPIC, AckermannDriveStamped, self.handleSafety)
    ...
    def handleSafety(self, laser_scan):
        pass
